...
import { serverChannel, channelMessage, user, dmChannel, server, emoji, img, serverUser, sticker, stickerMessage } from "./schema";
...
export const serverChannelRelations = relations(serverChannel, ({one, many}) => ({
